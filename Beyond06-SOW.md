...
###  1st challenge submission (October 15, 2021): Tool introduction challenge
...
###  2nd challenge submission (October 22, 2021): Git/GitHub workflow challenge
...
### Demo 1 (October 31, 2021): Project selection and setting up a DEV environment
...
### Demo 2 (November 21, 2021): Data model and basic testing
...
### Performance Review (between Nov 21 to Nov 26) :

TBD

### Demo 3 (December 12, 2021): Control logic and UI
...
### Demo 4 (January 2, 2022): Final Project Demo
...
## Division into project groups (till Friday, October 22, 2021)
...
|----------------|------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------|
|   1   |   10.10   |   General introduction    |   Liora Milbaum   |
|   |   |   1st challenge hand-off  |   Barak Korren    |
|   |   |   Architecture overview  |   Barak Korren    |
|   -   |   15.10   |   1st challenge submission    |   (Self work)   |
|   2   |   17.10   |  Introduction to Python    |   Kobi   |
|   |   |   2nd challenge hand-off  |   Barak Korren    |
|   -   |   22.10   |   2nd challenge submission    |   (Self work)   |
|   3   |   24.10   |  Data model and DB    |   Sim Zacks  |
|   |   |   Announce project teams and mentors  |   Liora Milbaum    |
|   4   |   31.10   |  Demo 1: Development environmen    |   (Presented by each group)  |
|   5   |   7.11   |  Business logic and testing    |   Edi  |
|   6   |   14.11   |  UI: Routes, Views and Templates    |   Yariv  |
|   7   |   21.11   |  Demo 2: Data model and business logic    |   (Presented by each group)  |
|   -   |   21.11 till 26.11   |  Personal feedback week    |   -  |
|   8   |   28.11   |  Going to production 1 - PAAS and containers   |   Barak Korren  |
|   -   |   5.12   |  (Hannucca holiday, no session)    |   -  |
|   9   |   12.12   |  Demo 3: UI   |   (Presented by each group)  |
|   10   |   19.12   | Going to production 2 - scaling up with Kubernetes   |   Barak Korren  |
|   11   |   26.12   | AMA - Being a software engineer in the industry   |   -  |
|   12   |   2.1   |  Final demo: integration   |   (Presented by each group)  |
